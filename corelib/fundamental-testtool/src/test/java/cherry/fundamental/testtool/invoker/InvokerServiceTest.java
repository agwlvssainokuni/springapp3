...
public class InvokerServiceTest {
	...
	public void testNoArgNoRet() throws Exception {
		...
		assertEquals("null", invokerService.invoke(null, ToolTester.class, list.get(0), null, null));
		assertEquals("null", invokerService.invoke("toolTesterImpl", ToolTester.class, list.get(0), null, null));
	}

	@Test
	public void testPrimitive() throws Exception {
		List<Method> list = resolver.resolveMethod(ToolTester.class, "toBeInvoked1");
		assertEquals("579", invokerService.invoke(null, ToolTester.class, list.get(0), asList("123", "456"), null));
	}
	...
	public void testLong() throws Exception {
		...
		assertEquals("579", invokerService.invoke(null, ToolTester.class, list.get(0), asList("123", "456"), null));
		assertEquals("null", invokerService.invoke(null, ToolTester.class, list.get(0), asList(null, "456"), null));
		assertEquals("null", invokerService.invoke(null, ToolTester.class, list.get(0), asList("123"), null));
		assertEquals("null", invokerService.invoke(null, ToolTester.class, list.get(0), null, null));
	}
	...
	public void testJodaTime() throws Exception {
		...
		assertEquals("\"2015-01-23T12:34:56\"", invokerService.invoke(null, ToolTester.class, list.get(0),
	...
	public void testNestedDto() throws Exception {
		...
		assertEquals("{\"val1\":{\"val1\":6,\"val2\":8},\"val2\":{\"val1\":10,\"val2\":12}}", invokerService.invoke(
				null,
				ToolTester.class,
				list.get(0),
	...
	public void testMethodIndex() throws Exception {
		...
		assertEquals("-1", invokerService.invoke(null, ToolTester.class, list.get(m0), asList("1", "2"), null));
		assertEquals("1", invokerService.invoke(null, ToolTester.class, list.get(m1), asList("1", "2"), null));
	}
