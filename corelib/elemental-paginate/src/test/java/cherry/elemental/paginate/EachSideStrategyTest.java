...
public class EachSideStrategyTest {
	...
	@Test
	public void testCalculateTrimmed() {
		...
		check(new Range(1, 2), strategy.calculate(0, 10));
		check(new Range(1, 3), strategy.calculate(1, 10));
		...
		check(new Range(6, 8), strategy.calculate(8, 10));
		check(new Range(7, 8), strategy.calculate(9, 10));
	}
