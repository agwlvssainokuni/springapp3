...
public class SimpleYearStrategy implements YearStrategy {
	...
	private final int yearOfFirstOffset;

	private final int monthOfFirst;

	private final int dayOfFirst;

	public SimpleYearStrategy(int yearOfFirstOffset, int monthOfFirst, int dayOfFirst) {
